...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    threshold_10_perc = 0.1 * threshold

    if temp_neutrons < (0.9 * threshold): return 'LOW'
    if temp_neutrons < (threshold - threshold_10_perc) or temp_neutrons < (threshold + threshold_10_perc): return 'NORMAL'
    return 'DANGER'
